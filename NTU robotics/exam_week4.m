...
T_12 = make_exp(e_ro([1 0 0]',deg2rad(-90)),[-30 0 0]')*make_exp(e_ro([0 0 1]',t2),[0 0 0]');
T_23 = make_exp(e_ro([1 0 0]',0),[340 0 0]')*make_exp(e_ro([0 0 1]',t3),[0 0 0]');
T_34 = make_exp(e_ro([1 0 0]',deg2rad(-90)),[-40 0 0]')*make_exp(e_ro([0 0 1]',t4),[0 0 338]');
