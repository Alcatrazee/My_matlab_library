...
emlrtContext emlrtContextGlobal = { true, false, 131434U, NULL, "sumab", NULL,
 ...
 * Return Type  : void
 */
void sumab_api(const mxArray * const prhs[2], const mxArray *plhs[1])
{
  real_T a;
  real_T b;
...
/*
 * File trailer for _coder_sumab_api.c
 *
 * [EOF]
 */
