 ...
 * _coder_sumab_info.c
 *
 * Code generation for function '_coder_sumab_info'
 *
 */
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", mxCreateString("sumab"));
...
/* End of code generation (_coder_sumab_info.c) */
