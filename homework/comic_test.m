%demostrate the comic of the AH-450 forward kinematic and six axis inverse
%kinematic ,increasing the angle of joint of AH-450,and thus give the result of the calculation to the six axis robot to reach the pos  
%two robots share the same base frame 
% V 1.0
...
for i=1:100
    %%%%%%%%%%%%%%%%%%%%% here change the joint angle %%%%%%%%%%%%%%%%%%%%%
    
    %%%%%%%%%%%%%%%%%%%%%       input the joint angles     %%%%%%%%%%%%%%%%%%%%
    angle_of_AH450=[i -i 0 -130];
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%     end     %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   %tic
    ...
    subplot(2,2,2)
    plot3(SA_x,SA_y,SA_z,'-bo','Markersize',markersize,'Linewidth',linewidth);
    hold on
    grid on
    title('two robots');
    ...
    %draw the skeleton of the 6 axis robot in pic. 2
    subplot(2,2,2)
    plot3(AH_x,AH_y,AH_z,'-ro','Markersize',markersize,'Linewidth',linewidth);
